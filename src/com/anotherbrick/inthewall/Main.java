...
public class Main extends PApplet {
   ...
   */
	...
	VizNotificationCenter notificationCenter = VizNotificationCenter
		.getInstance();
	...
	if (c.enableDrawMousePosition) {
	    ...
	    stroke(2);
	    fill(255);
	    rect((width - 80) * c.multiply, (height - 25) * c.multiply,
		    (80) * c.multiply, (25) * c.multiply);
    ...
    private void sendTouch(float x, float y, boolean down,
	    TouchTypeEnum touchType) {
	if (m.currentModalVizPanel == null) {
	    application.touch(x, y, down, TouchTypeEnum.ONE_FINGER);
	} else {
	    m.currentModalVizPanel.touch(x, y, down, TouchTypeEnum.ONE_FINGER);
	}
    }
